...
spring.data.jpa.repository.packages=com.mw.springboot.thymeleafdemo.dao
spring.data.jpa.entity.packages-to-scan=com.mw.springboot.thymeleafdemo.entity
...
In this case, the package name is: com.mw.springboot.thymeleafdemo.dao, so Spring Data JPA will scan for JPA repositories in this package. Spring Data JPA makes use of a entity manager factory bean and transacation manager.
